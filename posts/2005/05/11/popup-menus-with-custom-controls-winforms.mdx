...
The basic idea: you have a button (or something) which, when clicked, should show a dropdown containing some arbitrary controls. Maybe you need to drop down a two-column menu, or a set of checkboxes. Maybe you've got a "Preview <span style={{fontFamily: "webdings"}}>6</span>" button, and when the user clicks it, they should see a dropdown thumbnail of an image they selected earlier. Etc.
